/* clarity-js v0.7.56: https://github.com/microsoft/clarity (License: MIT) */ ! function() {
    "use strict";
    var t = Object.freeze({
            __proto__: null,
            get queue() {
    ...
    function j(t, e) {
        Ui() && t && "string" == typeof t && t.length < 255 && (A = e && "string" == typeof e && e.length < 255 ? {
            key: t,
            value: e
        } : {
            value: t
    ...
    function B() {
        ...
        R = {
            gap: t - q
        }, Xr(25), R.gap < 3e5 ? F = X(B, U) : Xi && (j("clarity", "suspend"), go(), ["mousemove", "touchstart"].forEach((function(t) {
    ...
    function et(t) {
        Ui() && o.lean && (o.lean = !1, tt = {
            key: t
        }, fi(), hi(), o.upgrade && o.upgrade(t), Xr(3))
    }
    ...
    function Vt() {
        _t = 1, Ct = [], Dt = [], At = {}, jt = [], Rt = [], Lt = "address,password,contact".split(","), zt = "password,secret,pass,social,ssn,code,hidden".split(","), Ht = "radio,checkbox,range,button,reset,submit".split(","), Pt = "INPUT,SELECT,TEXTAREA".split(","), It = new Map, Wt = new WeakMap, Xt = new WeakMap, Yt = new WeakMap, qt = new WeakMap, Nt = {}
    }
    ...
    var ce = Object.freeze({
            ...
            add: function(t, e, n, a) {
                var r = Jt(t, !0),
                    ...
                    d = o.content ? 1 : 3;
                i >= 0 && Ct[i] && ((c = Ct[i]).children.push(r), s = null === s ? c.region : s, l = null === l ? c.metadata.fraud : l, d = c.metadata.privacy), n.attributes && "data-clarity-region" in n.attributes && (Xa(t, n.attributes["data-clarity-region"]), s = r), It.set(r, t), Ct[r] = {
                        id: r,
                        parent: i,
                        previous: u,
                        children: [],
                    ...
                    function(t, e, n) {
                        ...
                        switch (!0) {
                            ...
                            case "*T" === c:
                                ...
                                i.privacy = v.includes(h) || jt.some((function(t) {
                    ...
                    function(t) {
                        if ("IMG" === t.data.tag && 3 === t.metadata.privacy) {
                            var e = te(t.id);
                            !e || e.complete && 0 !== e.naturalWidth || Ci(e, "load", (function() {
                ...
                if (r in Ct) {
                    ...
                    if (s.metadata.active = !0, s.previous !== o && (u = !0, s.previous = o), s.parent !== i) {
                        ...
                        if (s.parent = i, null !== i && i >= 0) {
                            ...
                            Ct[i].children.splice(d, 0, r), s.region = Ya(t) ? r : Ct[i].region
                        } else ! function(t, e) {
                            if (t in Ct) {
                                var n = Ct[t];
    ...
    function me() {
        ...
        t && (fe = t, t.task().then((function() {
            ...
            t.id === si() && (e && Er(0, 1, e.name, e.message, e.stack), fe = null, me())
        })))
    }
    ...
    var Oe, Te = window.requestIdleCallback || function(t, e) {
        ...
        r.onmessage = function(a) {
            var r = performance.now(),
                u = r - n,
                c = r - a.data;
            if (c > o.longTask && u < e.timeout) requestAnimationFrame((function() {
                i.postMessage(r)
            }));
            else {
                var s = u > e.timeout;
    ...
    function dn(t) {
        ...
        if (null === t && 0 === i && 0 === o || null === i || null === o) return cn = h, void(sn = p);
        var g = un.length,
            m = g > 1 ? un[g - 2] : null;
        m && function(t, e) {
            var n = t.data.x - e.data.x,
        ...
        }(m, v) && un.pop(), un.push(v), Y(ln), ln = X(hn, 500, 10)
    }
    ...
    function pn() {
        ...
        if (cn) {
            var n = Ga(cn, null);
            Qr(31, null === (t = null == n ? void 0 : n.hash) || void 0 === t ? void 0 : t.join("."))
        }
        if (sn) {
            var a = Ga(sn, null);
            Qr(32, null === (e = null == a ? void 0 : a.hash) || void 0 === e ? void 0 : e.join("."))
        }
    }
    var vn = null,
        gn = null,
    ...
    function yn(t) {
        ...
        if (null !== e && !(null === e.anchorNode && null === e.focusNode || e.anchorNode === e.focusNode && e.anchorOffset === e.focusOffset)) {
            ...
            null !== gn && null !== vn.start && n !== e.anchorNode && (Y(mn), bn(21)), vn = {
                start: e.anchorNode,
                startOffset: e.anchorOffset,
                end: e.focusNode,
                endOffset: e.focusOffset
            }, gn = e, Y(mn), mn = X(bn, 500, 21)
        }
    }
    ...
    function In(t) {
        ! function(t) {
            ...
            Ci(t, "cut", Xe.bind(this, 0), !0), Ci(t, "copy", Xe.bind(this, 1), !0), Ci(t, "paste", Xe.bind(this, 2), !0)
        }(t), function(t) {
            Ci(t, "mousedown", Ze.bind(this, 13, t), !0), Ci(t, "mouseup", Ze.bind(this, 14, t), !0), Ci(t, "mousemove", Ze.bind(this, 12, t), !0), Ci(t, "wheel", Ze.bind(this, 15, t), !0), Ci(t, "dblclick", Ze.bind(this, 16, t), !0), Ci(t, "touchstart", Qe.bind(this, 17, t), !0), Ci(t, "touchend", Qe.bind(this, 18, t), !0), Ci(t, "touchmove", Qe.bind(this, 19, t), !0), Ci(t, "touchcancel", Qe.bind(this, 20, t), !0)
        }(t), function(t) {
            Ci(t, "input", Fe, !0)
        }(t), function(t) {
    ...
    var Cn = Object.freeze({
        ...
        observe: In,
        start: function() {
            Za = [], $a(), Pe(), Ye(), en(), Be(), Ci(window, "resize", an), an(), Ci(document, "visibilitychange", xn), xn(), un = [], dn(), wn(), Ie(), Tn(), Ci(window, "pagehide", Nn)
        },
        stop: function() {
            Za = [], $a(), Pe(), Ye(), Y(Ke), Ge.length > 0 && tn(Ge[Ge.length - 1].event), Y(qe), Be(), on(), _n(), Y(ln), un = [], cn = null, sn = null, wn(), Y(mn), Ie(), Tn(), Mn()
        }
    });
    ...
    function Un() {
        if (An = [], Wn = [], Xn = null, Yn = 0, qn = {}, null === Rn && (Rn = CSSStyleSheet.prototype.insertRule, CSSStyleSheet.prototype.insertRule = function() {
                return Ui() && Gn(this.ownerNode), Rn.apply(this, arguments)
            }), "CSSMediaRule" in window && null === Hn && (Hn = CSSMediaRule.prototype.insertRule, CSSMediaRule.prototype.insertRule = function() {
                return Ui() && Gn(this.parentStyleSheet.ownerNode), Hn.apply(this, arguments)
            }), null === Ln && (Ln = CSSStyleSheet.prototype.deleteRule, CSSStyleSheet.prototype.deleteRule = function() {
                return Ui() && Gn(this.ownerNode), Ln.apply(this, arguments)
            }), "CSSMediaRule" in window && null === Pn && (Pn = CSSMediaRule.prototype.deleteRule, CSSMediaRule.prototype.deleteRule = function() {
                return Ui() && Gn(this.parentStyleSheet.ownerNode), Pn.apply(this, arguments)
            }), null === zn) {
            zn = Element.prototype.attachShadow;
            try {
                Element.prototype.attachShadow = function() {
                    return Ui() ? Gn(zn.apply(this, arguments)) : zn.apply(this, arguments)
                }
            } catch (t) {
                zn = null
            }
            ...
            return rt(this, (function(f) {
                switch (f.label) {
                    ...
                    case 1:
                        ...
                        e = jn.shift(), n = s(), a = 0, r = e.mutations, f.label = 2;
                    case 2:
                        ...
                        switch (c = i.target, l = o.throttleDom ? function(t, e, n, a) {
                            ...
                            if (r && "HTML" !== r.data.tag) {
                                var i = a > Yn,
                                    ...
                                    c = [r.selector ? r.selector.join() : "", u, t.attributeName, Bn(t.addedNodes), Bn(t.removedNodes)].join();
                                qn[c] = c in qn ? qn[c] : [0, n];
                                var s = qn[c];
                                if (!1 === i && s[0] >= 10 && Jn(s[2], 2, e, a), s[0] = i ? s[1] === n ? s[0] : s[0] + 1 : 1, s[1] = n, 10 === s[0]) return s[2] = t.removedNodes, "suspend";
                                if (s[0] > 10) return ""
                            }
                            return t.type
                            ...
                            case "characterData":
                                ...
                                break;
                            case "childList":
                                Jn(i.addedNodes, 1, t, e.time), Jn(i.removedNodes, 2, t, e.time);
                                break;
                            case "suspend":
        ...
        return at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(u) {
                switch (u.label) {
                    ...
                    case 1:
                        return i < r ? 1 !== e ? [3, 2] : (Dn(t[i], n, e, a), [3, 5]) : [3, 6];
                    case 2:
    ...
    function Gn(t) {
        return Wn.indexOf(t) < 0 && Wn.push(t), Xn && Y(Xn), Xn = X((function() {
            ! function() {
        ...
        for (var e = 0, n = Object.keys(t); e < n.length; e++) {
            ...
            if ("@type" === a && "string" == typeof r) switch (r = (r = r.toLowerCase()).indexOf("article") >= 0 || r.indexOf("posting") >= 0 ? "article" : r) {
                ...
                case "aggregaterating":
                    t.ratingValue && (W(11, $n(t.ratingValue, 100)), W(18, $n(t.bestRating)), W(19, $n(t.worstRating))), W(12, $n(t.ratingCount)), W(17, $n(t.reviewCount));
                    break;
                case "offer":
                    Qr(7, t.availability), Qr(14, t.itemCondition), Qr(13, t.priceCurrency), Qr(12, t.sku), W(13, $n(t.price));
                    break;
                case "brand":
                    Qr(6, t.name)
            }
            ...
            case Node.ELEMENT_NODE:
                ...
                switch (o = t.parentElement ? t.parentElement : t.parentNode ? t.parentNode : null, "http://www.w3.org/2000/svg" === h.namespaceURI && (p = "svg:" + p), p) {
                    ...
                    case "IFRAME":
                        ...
                        Gt(T) && (! function(t) {
                            !1 === ae(t) && Ci(t, "load", Kn.bind(this, t, "childList"), !0)
                        }(T), N.attributes["*O"] = "true", T.contentDocument && T.contentWindow && "loading" !== T.contentDocument.readyState && (r = T.contentDocument)), ce[i](t, o, N, e);
                        break;
                    case "LINK":
    ...
    function ia(t) {
        ...
        try {
            ...
            if (Er(1, 1, t ? t.name : null), t && "SecurityError" !== t.name) throw t
        }
        if (null !== n)
    ...
    function va(t, e) {
        if (-1 === pa.indexOf(t) && pa.push(t), e = e || s(), null == t ? void 0 : t.adoptedStyleSheets) {
            W(36, 1);
            for (var n = [], a = 0, r = t.adoptedStyleSheets; a < r.length; a++) {
                var i = r[a],
                    o = ni.pageNum;
                i[da] !== o && (i[da] = o, i[la] = gi(), ma(e, i[la], 0), ma(e, i[la], 2, ia(i))), n.push(i[la])
            }
            var u = Jt(t, !0);
            fa[u] || (fa[u] = []),
                function(t, e) {
                ...
                }(e, t == document ? -1 : Jt(t), 3, n), fa[u] = n, ha[u] = e)
        }
    }
            ...
            return rt(this, (function(z) {
                switch (z.label) {
                    case 0:
                        ...
                        return [3, 12];
                    case 1:
                        return i = Oe, r.push(i.width), r.push(i.height), x(t, i.width, i.height), dr(r), [3, 12];
                    case 2:
                        for (u = 0, c = Ra; u < c.length; u++) l = c[u], (r = [l.time, 7]).push(l.data.id), r.push(l.data.interaction), r.push(l.data.visibility), r.push(l.data.name), dr(r);
                        return Ba(), [3, 12];
                    case 3:
                        for (d = 0, f = ua; d < f.length; d++) y = f[d], (r = [y.time, y.event]).push(y.data.id), r.push(y.data.operation), r.push(y.data.newIds), dr(r);
                        for (h = 0, p = oa; h < p.length; h++) y = p[h], (r = [y.time, y.event]).push(y.data.id), r.push(y.data.operation), r.push(y.data.cssRules), dr(r);
                        return ga(), [3, 12];
                    case 4:
                        for (v = 0, g = ya; v < g.length; v++) y = g[v], (r = [y.time, y.event]).push(y.data.id), r.push(y.data.operation), r.push(y.data.keyFrames), r.push(y.data.timing), r.push(y.data.timeline), r.push(y.data.targetId), dr(r);
                        return Ma(), [3, 12];
                    case 5:
                    ...
                    case 8:
                        if (2 === E) return [3, 10];
                        for (O = S.data, T = S.metadata.active, N = S.metadata.suspend, M = S.metadata.privacy, I = function(t) {
                                var e = t.metadata.privacy;
                                return "*T" === t.data.tag && !(0 === e || 1 === e)
                            }(S), C = 0, D = T ? ["tag", "attributes", "value"] : ["tag"]; C < D.length; C++)
                            if (O[A = D[C]]) switch (A) {
                                case "tag":
                                    j = Da(S), R = I ? -1 : 1, r.push(S.id * R), S.parent && T && (r.push(S.parent), S.previous && r.push(S.previous)), r.push(N ? "*M" : O[A]), j && 2 === j.length && r.push("".concat("#").concat(Aa(j[0]), ".").concat(Aa(j[1])));
                                    break;
                                case "attributes":
                                    for (L in O[A]) void 0 !== O[A][L] && r.push(ja(L, O[A][L], M));
                                    break;
                                case "value":
                                    Ot(S.metadata.fraud, S.id, O[A]), r.push(m(O[A], O.tag, M, I))
                            }
                        z.label = 9;
                    case 9:
                        return w++, [3, 6];
                    case 10:
                        6 === t && _(a), dr(function(t) {
    ...
    function Xa(t, e) {
        !1 === La.has(t) && (La.set(t, e), (Wa = null === Wa && Pa ? new IntersectionObserver(Ua, {
            threshold: [0, .05, .1, .2, .3, .4, .5, .6, .7, .8, .9, 1]
        }) : Wa) && t && t.nodeType === Node.ELEMENT_NODE && Wa.observe(t))
    }
    ...
    function qa() {
        for (var t = [], e = 0, n = Ha; e < n.length; e++) {
            var a = n[e],
                r = Jt(a.node);
            r ? (a.state.data.id = r, za[r] = a.state.data, Ra.push(a.state)) : t.push(a)
        }
    ...
    function Ua(t) {
        for (var e = 0, n = t; e < n.length; e++) {
            ...
            if (La.has(r) && i.width + i.height > 0 && u.width > 0 && u.height > 0) {
                ...
                Fa(r, s, s.interaction, d ? 13 : l ? 10 : 0), s.visibility >= 13 && Wa && Wa.unobserve(r)
            }
        }
        Ra.length > 0 && Ca(7)
    }
    ...
    function Fa(t, e, n, a) {
        ...
        e.interaction = n > e.interaction ? n : e.interaction, e.visibility = a > e.visibility ? a : e.visibility, e.id ? (e.id in za && r || !(e.id in za)) && (za[e.id] = e, Ra.push(Va(e))) : Ha.push({
            node: t,
            state: Va(e)
        })
    }
    ...
    function Ja(t) {
        ...
        return Yn = s() + 3e3, n && n.nodeType === Node.DOCUMENT_NODE ? n.documentElement : n
    }
        ...
        return void 0 === e && (e = null), at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(Y) {
                switch (n = e || s(), a = [n, t], t) {
                    ...
                    case 19:
                    case 20:
                        for (r = 0, i = Ge; r < i.length; r++) W = i[r], (o = Ga(W.data.target, W.event)).id > 0 && ((a = [W.time, W.event]).push(o.id), a.push(W.data.x), a.push(W.data.y), void 0 !== W.data.id && a.push(W.data.id), dr(a), x(W.event, W.data.x, W.data.y));
                        en();
                        break;
                    case 9:
                        for (u = 0, c = Ae; u < c.length; u++) W = c[u], l = Ga(W.data.target, W.event, W.data.text), a = [W.time, W.event], d = l.hash ? l.hash.join(".") : "", a.push(l.id), a.push(W.data.x), a.push(W.data.y), a.push(W.data.eX), a.push(W.data.eY), a.push(W.data.button), a.push(W.data.reaction), a.push(W.data.context), a.push(m(W.data.text, "click", l.privacy)), a.push(y(W.data.link)), a.push(d), a.push(W.data.trust), dr(a), tr(W.time, W.event, d, W.data.x, W.data.y, W.data.reaction, W.data.context);
                        Pe();
                        break;
                    case 38:
                        for (f = 0, h = We; f < h.length; f++) W = h[f], a = [W.time, W.event], (z = Ga(W.data.target, W.event)).id > 0 && (a.push(z.id), a.push(W.data.action), dr(a));
                        Ye();
                        break;
                    case 11:
                        p = Je, a.push(p.width), a.push(p.height), x(t, p.width, p.height), on(), dr(a);
                        break;
                    case 26:
                        v = kn, a.push(v.name), Mn(), dr(a);
                        break;
                    case 27:
                        for (g = 0, b = Ue; g < b.length; g++) W = b[g], w = Ga(W.data.target, W.event, W.data.value), (a = [W.time, W.event]).push(w.id), a.push(m(W.data.value, "input", w.privacy, !1, W.data.type)), dr(a);
                        Be();
                        break;
                    case 21:
                        (k = vn) && (S = Ga(k.start, t), E = Ga(k.end, t), a.push(S.id), a.push(k.startOffset), a.push(E.id), a.push(k.endOffset), wn(), dr(a));
                        break;
                    case 10:
                        for (O = 0, T = un; O < T.length; O++) W = T[O], N = Ga(W.data.target, W.event), M = Ga(W.data.top, W.event), _ = Ga(W.data.bottom, W.event), C = (null == M ? void 0 : M.hash) ? M.hash.join(".") : "", D = (null == _ ? void 0 : _.hash) ? _.hash.join(".") : "", N.id > 0 && ((a = [W.time, W.event]).push(N.id), a.push(W.data.x), a.push(W.data.y), a.push(C), a.push(D), dr(a), x(W.event, W.data.x, W.data.y, W.time));
                        un = [], cn = null, sn = null;
                        break;
                    case 42:
                        for (A = 0, j = xe; A < j.length; A++) W = j[A], a = [W.time, W.event], (z = Ga(W.data.target, W.event)).id > 0 && ((a = [W.time, W.event]).push(z.id), a.push(W.data.type), a.push(m(W.data.value, "change", z.privacy)), a.push(m(W.data.checksum, "checksum", z.privacy)), dr(a));
                        Ie();
                        break;
                    case 39:
                        for (R = 0, L = En; R < L.length; R++) W = L[R], a = [W.time, W.event], (z = Ga(W.data.target, W.event)).id > 0 && (a.push(z.id), dr(a));
                        Tn();
                        break;
                    case 22:
                        for (H = 0, P = Qa; H < P.length; H++) W = P[H], (a = [W.time, W.event]).push(W.data.type), a.push(W.data.hash), a.push(W.data.x), a.push(W.data.y), a.push(W.data.reaction), a.push(W.data.context), dr(a, !1);
                        $a();
                        break;
                    case 28:
    ...
    var er, nr, ar, rr, ir, or = 0,
        ur = 0,
        cr = null,
        sr = 0;

    function lr() {
        rr = !0, or = 0, ur = 0, sr = 0, er = [], nr = [], ar = {}, ir = null
    }
    ...
    function dr(t, e) {
        if (void 0 === e && (e = !0), rr) {
            ...
            n - sr > 2 * i && (Y(cr), cr = null), e && null === cr && (25 !== a && V(), cr = X(hr, i), sr = n, qr(ur))
        }
    }

    function fr() {
        Y(cr), hr(!0), or = 0, ur = 0, sr = 0, er = [], nr = [], ar = {}, ir = null, rr = !1
    }
    ...
    function hr(t) {
        return void 0 === t && (t = !1), at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(l) {
                switch (l.label) {
                    case 0:
                        return cr = null, (e = !1 === o.lean && ur > 0 && (ur < 1048576 || Ei.sequence > 0)) && W(1, 1), qa(),
                            function() {
                                var t = [];
                                Qa = [];
                                for (var e = Ei.start + Ei.duration, n = Math.max(e - 2e3, 0), a = 0, r = Za; a < r.length; a++) {
                                    var i = r[a];
                            ...
                            }(), n = !0 === t, a = JSON.stringify(Ni(n)), r = "[".concat(nr.join(), "]"), i = e ? "[".concat(er.join(), "]") : "", u = function(t) {
                    ...
                    case 2:
                        s = l.sent(), l.label = 3;
                    case 3:
                        return P(2, (c = s) ? c.length : u.length), pr(u, c, Ei.sequence, n), nr = [], e && (er = [], ur = 0, or = 0), [2]
                }
            }))
        }))
    }
    ...
    function vr(t, e) {
        var n = ar[e];
        t && 4 === t.readyState && n && ((t.status < 200 || t.status > 208) && n.attempts <= 1 ? t.status >= 400 && t.status < 500 ? Ur(6) : (0 === t.status && (o.upload = o.fallback ? o.fallback : o.upload), pr(n.data, null, e)) : (ir = {
            sequence: e,
            attempts: n.attempts,
            status: t.status
        ...
        }(t.responseText), 0 === t.status && (pr(n.data, null, e, !0), Ur(3)), t.status >= 200 && t.status <= 208 && gr(e), delete ar[e]))
    }
    ...
    function br(t) {
        var e = t.error || t;
        return e.message in yr || (yr[e.message] = 0), yr[e.message]++ >= 5 || e && e.message && (mr = {
            message: e.message,
            line: t.lineno,
            column: t.colno,
            stack: e.stack,
    ...
    function wr(t) {
        return at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(n) {
                switch (e = [s(), t], t) {
                    case 31:
                        e.push(mr.message), e.push(mr.line), e.push(mr.column), e.push(mr.stack), e.push(y(mr.source)), dr(e);
                        break;
                    case 33:
                        kr && (e.push(kr.code), e.push(kr.name), e.push(kr.message), e.push(kr.stack), e.push(kr.severity), dr(e, !1));
                        break;
                    case 41:
                        St && (e.push(St.id), e.push(St.target), e.push(St.checksum), dr(e, !1))
                }
                return [2]
            }))
        }))
    ...
    function Er(t, e, n, a, r) {
        ...
        t in Sr && Sr[t].indexOf(i) >= 0 || (kr = {
            code: t,
            name: n,
            message: a,
            stack: r,
            severity: e
        }, t in Sr ? Sr[t].push(i) : Sr[t] = [i], wr(33))
    }
    var Or, Tr = {},
        Nr = new Set,
        Mr = {},
    ...
    function Dr(t) {
        try {
            ...
            for (var o in Mr[a] = {}, xr[a] = {}, _r[a] = {}, Ir[a] = r, i) {
                var u = parseInt(o),
                    c = i[o],
                    s = 2;
            ...
            for (var t in Mr) {
                ...
                if ("" == Ir[e] || document.querySelector(Ir[e])) {
                    ...
                    for (var u in o) {
                        ...
                        if (s) Lr(e, c, Array.from(s).map((function(t) {
    ...
    function Lr(t, e, n) {
        var a, r = !1;
        t in Tr || (Tr[t] = {}, r = !0), a = _r[t], 0 == Object.keys(a).length || e in Tr[t] && Tr[t][e] == n || (r = !0), Tr[t][e] = n, r && Nr.add(t)
    }
    ...
    function Xr(t) {
        ...
        switch (t) {
            case 4:
                var n = O;
                n && ((e = [n.time, n.event]).push(n.data.visible), e.push(n.data.docWidth), e.push(n.data.docHeight), e.push(n.data.screenWidth), e.push(n.data.screenHeight), e.push(n.data.scrollX), e.push(n.data.scrollY), e.push(n.data.pointerX), e.push(n.data.pointerY), e.push(n.data.activityTime), e.push(n.data.scrollTime), dr(e, !1)), M();
                break;
            case 25:
                e.push(R.gap), dr(e);
                break;
    ...
    function qr(t) {
        if (0 === Or.check) {
            var e = Or.check;
            e = Ei.sequence >= 128 ? 1 : e, e = Ei.pageNum >= 128 ? 7 : e, e = s() > 72e5 ? 2 : e, (e = t > 10485760 ? 2 : e) !== Or.check && Ur(e)
        }
    }
    ...
    function Qr(t, e) {
        if (e && (e = "".concat(e), t in Br || (Br[t] = []), Br[t].indexOf(e) < 0)) {
    ...
    function oi() {
        ...
        var s, l = function() {
                ...
                if (e) {
                    var n = e.split("|");
                    n.length >= 5 && t.ts - mi(n[1]) < 18e5 && (t.session = n[0], t.count = mi(n[2]) + 1, t.upgrade = mi(n[3]), t.upload = n.length >= 6 ? "".concat("https://").concat(n[5], "/").concat(n[4]) : "".concat("https://").concat(n[4]))
                }
                return t
            }(),
            f = yi(),
        ...
        ni = {
            ...
            sessionId: l.session,
            pageNum: l.count
        }, o.lean = o.track && null !== l.upgrade ? 0 === l.upgrade : o.lean, o.upload = o.track && "string" == typeof o.upload && l.upload && l.upload.length > "https://".length ? l.upload : o.upload, Qr(0, a), Qr(3, c), Qr(1, y(location.href, !!ri)), Qr(2, document.referrer), Qr(15, function() {
            var t = gi();
            ...
            return t
        }()), Qr(16, document.documentElement.lang), Qr(17, document.dir), Qr(26, "".concat(window.devicePixelRatio)), Qr(28, f.dob.toString()), Qr(29, f.version.toString()), Qr(33, u), Qr(34, r), Qr(35, i), W(0, l.ts), W(1, 0), W(35, ri), navigator && (Qr(9, navigator.language), W(33, navigator.hardwareConcurrency), W(32, navigator.maxTouchPoints), W(34, Math.round(navigator.deviceMemory)), (s = navigator.userAgentData) && s.getHighEntropyValues ? s.getHighEntropyValues(["model", "platform", "platformVersion", "uaFullVersion"]).then((function(t) {
            var e;
            Qr(22, t.platform), Qr(23, t.platformVersion), null === (e = t.brands) || void 0 === e || e.forEach((function(t) {
                Qr(24, t.name + "~" + t.version)
            })), Qr(25, t.model), W(27, t.mobile ? 1 : 0)
        })) : Qr(22, navigator.platform)), screen && (W(14, Math.round(screen.width)), W(15, Math.round(screen.height)), W(16, Math.round(screen.colorDepth)));
    ...
    function ui() {
        ii = null, ni = null, ai.forEach((function(t) {
            t.called = !1
        }))
    }
    ...
    function ci(t, e, n) {
        ...
        var a = o.lean ? 0 : 1,
            r = !1;
        ni && (a || !1 === e) && (t(ni, !o.lean), r = !0), !n && r || ai.push({
            callback: t,
            wait: e,
            recall: n,
            called: r
    ...
    function li(t) {
        if (void 0 === t && (t = !0), !t) return o.track = !1, ki("_clsk", "", -Number.MAX_VALUE), ki("_clck", "", -Number.MAX_VALUE), go(), void window.setTimeout(vo, 250);
        ...
        ! function(t) {
            if (ai.length > 0)
                for (var e = 0; e < ai.length; e++) {
                    var n = ai[e];
                    !n.callback || n.called || n.wait && !t || (n.callback(ni, !o.lean), n.called = !0, n.recall || (ai.splice(e, 1), e--))
                }
        }(o.lean ? 0 : 1)
    }
    ...
    function vi(t, e) {
        ...
        (null === t.expiry || Math.abs(n - t.expiry) >= 1 || t.consent !== e || t.dob !== a) && ki("_clck", [ni.userId, 2, n.toString(36), e, a].join("|"), 365)
    }
    ...
    function yi() {
        ...
        if (e && e.length > 0) {
            ...
            n.length > 1 && (t.version = mi(n[1])), n.length > 2 && (t.expiry = mi(n[2], 36)), n.length > 3 && 1 === mi(n[3]) && (t.consent = 1), n.length > 4 && mi(n[1]) > 1 && (t.dob = mi(n[4])), o.track = o.track || 1 === t.consent, t.id = o.track ? n[0] : t.id
        }
        return t
    }
            ...
            if (n)
                for (var a = 0; a < n.length; a++) {
                    ...
                    if (r.length > 1 && r[0] && r[0].trim() === t) {
                        for (var i = wi(r[1]), o = i[0], u = i[1]; o;) o = (e = wi(u))[0], u = e[1];
                        return u
                    }
                }
        }
    ...
    function ki(t, e, n) {
        if ((o.track || "" == e) && (navigator && navigator.cookieEnabled || pi(document, "cookie"))) {
            var a = function(t) {
            ...
            try {
                if (null === ii) {
                    for (var c = location.hostname ? location.hostname.split(".") : [], s = c.length - 1; s >= 0; s--)
                        if (ii = ".".concat(c[s]).concat(ii || ""), s < c.length - 1 && (document.cookie = "".concat(u).concat(";").concat("domain=").concat(ii), bi(t) === e)) return;
                    ii = ""
                }
            } catch (t) {
                ii = ""
            }
            document.cookie = ii ? "".concat(u).concat(";").concat("domain=").concat(ii) : u
        }
    }
    var Si, Ei = null;
    ...
    function Ni(t) {
        return Ei.start = Ei.start + Ei.duration, Ei.duration = s() - Ei.start, Ei.sequence++, Ei.upload = t && "sendBeacon" in navigator ? 1 : 0, Ei.end = t ? 1 : 0, [Ei.version, Ei.sequence, Ei.start, Ei.duration, Ei.projectId, Ei.userId, Ei.sessionId, Ei.pageNum, Ei.upload, Ei.end]
    }
    ...
    function Ci(t, e, n, a) {
        void 0 === a && (a = !1), n = _i(n);
        try {
            t[u("addEventListener")](e, n, a), Ii.push({
                event: e,
                target: t,
                listener: n,
                capture: a
    ...
    function Yi() {
        Xi = !0, c = performance.now() + performance.timeOrigin, ve(), Di(), Mi(), Ri = Wi(), Li = 0, Ci(window, "popstate", Hi), null === Ai && (Ai = history.pushState, history.pushState = function() {
            Ai.apply(this, arguments), Ui() && zi() && Hi()
        }), null === ji && (ji = history.replaceState, history.replaceState = function() {
    ...
    var Ji = Object.freeze({
        ...
        hashText: $t,
        start: function() {
            Ne(), Me(), Ba(), Wa = null, La = new WeakMap, za = {}, Ha = [], Pa = !!window.IntersectionObserver, Ut(), o.delayDom ? Ci(window, "load", (function() {
                    Un()
                })) : Un(), ge(Bi, 1).then((function() {
                    _i(Me)(), _i(qa)(), _i(pn)()
                })), null === ca && (ca = CSSStyleSheet.prototype.replace, CSSStyleSheet.prototype.replace = function() {
                    return Ui() && (W(36, 1), this[da] === ni.pageNum && ma(s(), this[la], 1, arguments[0])), ca.apply(this, arguments)
                }), null === sa && (sa = CSSStyleSheet.prototype.replaceSync, CSSStyleSheet.prototype.replaceSync = function() {
                    return Ui() && (W(36, 1), this[da] === ni.pageNum && ma(s(), this[la], 2, arguments[0])), sa.apply(this, arguments)
                }),
                function() {
                    if (window.Animation && window.KeyframeEffect && window.KeyframeEffect.prototype.getKeyframes && window.KeyframeEffect.prototype.getTiming && (Ma(), _a(wa, "play"), _a(ka, "pause"), _a(Sa, "cancel"), _a(Ea, "finish"), null === ba && (ba = Element.prototype.animate, Element.prototype.animate = function() {
                            var t = ba.apply(this, arguments);
                            return Ia(t, "play"), t
                        }), document.getAnimations))
                        for (var t = 0, e = document.getAnimations(); t < e.length; t++) {
                            var n = e[t];
                            "finished" === n.playState ? Ia(n, "finish") : "paused" === n.playState || "idle" === n.playState ? Ia(n, "pause") : "running" === n.playState && Ia(n, "play")
                        }
                }()
        },
        stop: function() {
            Ba(), La = null, za = {}, Ha = [], Wa && (Wa.disconnect(), Wa = null), Pa = !1, Ft(),
                function() {
        ...
        Gi = {
            ...
            function(t) {
                at(this, void 0, void 0, (function() {
                    var e, n;
                    return rt(this, (function(a) {
                        return e = s(), n = [e, t], 29 === t && (n.push(Gi.fetchStart), n.push(Gi.connectStart), n.push(Gi.connectEnd), n.push(Gi.requestStart), n.push(Gi.responseStart), n.push(Gi.responseEnd), n.push(Gi.domInteractive), n.push(Gi.domComplete), n.push(Gi.loadEventStart), n.push(Gi.loadEventEnd), n.push(Gi.redirectCount), n.push(Gi.size), n.push(Gi.type), n.push(Gi.protocol), n.push(Gi.encodedSize), n.push(Gi.decodedSize), Ki(), dr(n)), [2]
                    }))
                }))
            }(29)
    }
    var Qi, $i = 0,
        ...
        co = function(t) {
            if (t.interactionId && !(t.duration < 40)) {
                ! function(t) {
                    "interactionCount" in performance ? $i = performance.interactionCount : t.interactionId && (to = Math.min(to, t.interactionId), eo = Math.max(eo, t.interactionId), $i = eo ? (eo - to) / 7 + 1 : 0)
                }(t);
                var e = ao[ao.length - 1],
                    n = ro.get(t.interactionId);
                if (n || ao.length < 10 || t.duration > (null == e ? void 0 : e.latency)) {
                    ...
                    })), ao.length > 10 && ao.splice(10).forEach((function(t) {
    ...
    function lo() {
        try {
            ...
            for (var t = 0, e = so; t < e.length; t++) {
                var n = e[t];
                PerformanceObserver.supportedEntryTypes.indexOf(n) >= 0 && ("layout-shift" === n && P(9, 0), Qi.observe({
                    type: n,
                    buffered: !0
                }))
            }
        ...
        ! function(t) {
            for (var e = (!("visibilityState" in document) || "visible" === document.visibilityState), n = 0; n < t.length; n++) {
                ...
                switch (a.entryType) {
                    ...
                    case "resource":
                        var r = a.name;
                        Qr(4, ho(r)), r !== o.upload && r !== o.fallback || W(28, a.duration);
                        break;
                    case "longtask":
                        H(7);
                        break;
                    case "first-input":
                        ...
                        break;
                    case "event":
                        e && "PerformanceEventTiming" in window && "interactionId" in PerformanceEventTiming.prototype && (co(a), Qr(37, oo().toString()));
                        break;
                    case "layout-shift":
    ...
    var po = [Vi, Ji, Cn, Object.freeze({
        __proto__: null,
        start: function() {
            Ki(),
                function() {
                    navigator && "connection" in navigator && Qr(27, navigator.connection.effectiveType), window.PerformanceObserver && PerformanceObserver.supportedEntryTypes ? "complete" !== document.readyState ? Ci(window, "load", X.bind(this, lo, 0)) : lo() : Er(3, 0)
                }()
        },
        stop: function() {
        ...
        void 0 === t && (t = null),
            function() {
                try {
                    ...
                    return !1 === Xi && "undefined" != typeof Promise && window.MutationObserver && document.createTreeWalker && "now" in Date && "now" in performance && "undefined" != typeof WeakMap && !t
                } catch (t) {
                    return !1
                }
            }() && (! function(t) {
            ...
            }(t), Yi(), bt(), po.forEach((function(t) {
                return _i(t.start)()
            })), null === t && wo())
    }

    function go() {
        Ui() && (po.slice().reverse().forEach((function(t) {
            return _i(t.stop)()
        })), wt(), qi(), void 0 !== yo && (yo[bo] = function() {
            (yo[bo].q = yo[bo].q || []).push(arguments), "start" === arguments[0] && yo[bo].q.unshift(yo[bo].q.pop()) && wo()
        }))
    }
    var mo = Object.freeze({
            ...
            metadata: ci,
            pause: function() {
                Ui() && (j("clarity", "pause"), null === he && (he = new Promise((function(t) {
                    pe = t
                }))))
            },
            resume: function() {
                Ui() && (he && (pe(), he = null, null === fe && me()), j("clarity", "resume"))
            },
            set: ot,
            signal: function(t) {
                gt = t
    ...
    function wo() {
        if (void 0 !== yo) {
            if (yo[bo] && yo[bo].v) return console.warn("Error CL001: Multiple Clarity tags detected.");
            var t = yo[bo] && yo[bo].q || [];
            for (yo[bo] = function(t) {
                    for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
                    return mo[t].apply(mo, e)
                }, yo[bo].v = l; t.length > 0;) yo[bo].apply(yo, t.shift())
        }
    }
    wo()
}();