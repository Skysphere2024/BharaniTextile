...
! function() {
        ...
        u = ((P = I = I || {})[P.None = 0] = "None", P[P.Cookie = 1] = "Cookie", P[P.LocalStorage = 2] = "LocalStorage", P[P.Library = 3] = "Library", o.checkLocalStorageIsWritable = function() {
            ...
            for (var n = new Date, o = (n.setTime(n.getTime() + t), "expires=" + n.toUTCString()), i = null === document.location ? [] : document.location.hostname.split("."), r = null, a = 0; a < i.length; ++a) {
                var c = "domain=." + (r = i.slice(i.length - a - 1, i.length).join(".")),
                    ...
                    s = (document.cookie = this.cookieName + "=" + s(e) + ";" + o + ";" + c + ";path=/", this.getValue());
                if (s && s === e) break
            }
    ...
    s.prototype.preload = function() {
    ...
    }, s.prototype.onUserIdAvailable = function(o, i) {
        function r(e) {
            var t, n;
            c || (t = e * s.retryIntervalMs, void 0 !== (n = a.instance()) ? (c = !0, n.onUpdate(function(e) {
                e = e.getUserId();
                return a.logger("user ID available:", e), void 0 !== e && localStorage.setItem(s.localStorageKey, e), o(e)
            })) : i <= t ? (c = !0, a.logger("timeout waiting for instance after waiting (ms):", t), o(void 0)) : (a.exceptionHandler.setProtectedTimeout(function() {
                return r(e)
            }, s.retryIntervalMs), e++))
        }
        var a = this,
        ...
        e = localStorage.getItem(s.localStorageKey);
    ...
    }, s.criteoPartnerId = 203, s.retryIntervalMs = 100, s.maxWaitForApiMs = 2e4, s.localStorageKey = "criteo-id5id-fast-track";
    var G = s;
        ...
        this.logger = function() {
            ...
            return W.debug.apply(W, function() {
                ...
                for (var o = Array(e), i = 0, t = 0; t < n; t++)
                    for (var r = arguments[t], a = 0, c = r.length; a < c; a++, i++) o[i] = r[a];
                return o
            }(["[ID5]"], e))
    ...
    l.prototype.getCMPFrame = function() {
    ...
    }, l.prototype.pingWithTimeout = function(o, e, t, n) {
        function i(e, t) {
    ...
    }, l.prototype.retrieveConsent = function(e) {
        this.executeRetrieveConsent("getConsentData", null, e)
    }, l.prototype.retrieveConsentForPassback = function(e) {
        this.executeRetrieveConsent("getVendorConsents", [91], e)
    }, l.prototype.executeRetrieveConsent = function(e, t, n) {
        var o = this,
            i = !1,
    ...
    }, l.prototype.processConsentData = function(e, t) {
        var n;
    ...
    }, l.prototype.executeCommand = function(e, t, n) {
        var o, i = this;
        this.hasCallerFunctionInFrame() || (this.logger("No GDPR CMP defined on current frame"), o = this.getCMPFrame(), this.currentWindow.__cmp = function(e, t, n) {
            ...
            var e = "string" == typeof e.data ? c(e.data) : e.data;
    ...
    function l(e, t, n) {
        ...
        var o, i, r = this,
            ...
            s = !1 !== this.cmpAutoDetect ? this.pingWithTimeout(c, this.pingTimeout, this.pingDelay, function() {
        ...
        this.executeCommand("addEventListener", 2, function(e, t) {
            clearTimeout(s), a || ((i = e.eventStatus) !== d.UI_SHOWN && clearTimeout(c), t ? (r.logger("TCFv2 consent retrieved in ms"), e || (r.logger("Unable to read GDPR consent data from CMP"), n(void 0)), o = r.processResponseData(e), (!1 === e.gdprApplies && void 0 === i || i === d.LOADED || i === d.USER_ACTION_COMPLETE) && n(o)) : (r.logger("Error retrieving TCFv2 consent data from CMP"), n(void 0)))
        })
    ...
    function g(e, t, n, o) {
        this.readonlyCookieRetentionTime = 0, this.optoutCookieRetentionTime = 15768e7, this.identificationCookieRetentionTime = 34164e6, this.optoutCookie = new u("cto_optout", this.optoutCookieRetentionTime), this.bundleCookie = new u("cto_bundle", this.identificationCookieRetentionTime), this.ifaCookie = new u("id_controller_ifa", this.identificationCookieRetentionTime), this.socialCookie = new O, this.canWriteCookie = !1, this.canWriteLocalStorage = !1, this.clickOriginPayload = null, this.tld = this.getTld(), this.privateMode = this.getPrivateMode(t, n), this.exceptionHandler = e, this.config = o
    }
    ...
    y.prototype.createIframe = function(e, t, n, o, i) {
        var r = document.createElement("iframe"),
            ...
            c = N.getHighestAccessibleUrl(window),
            a = a(N.extractHostname(c)),
            ...
            e = ("#gum-debug-mode" === window.location.hash ? o += "?debug=1&topUrl=" + a : o += "?topUrl=" + a, c && (o += "&origin=" + c), i.gdprConsent),
            a = (e && (void 0 !== e.gdprApplies && (o += "&gdpr=" + (e.gdprApplies ? 1 : 0)), void 0 !== e.consentData) && (o += "&gdpr_consent=" + e.consentData), i.ccpaConsent);
        return a && void 0 !== a.uspString && (o += "&us_privacy=" + a.uspString), o += "#" + JSON.stringify(t), r.src = o, r.id = this.gumSyncFrameId, r.width = "0", r.height = "0", r.frameBorder = "0", r.setAttribute("style", "border-width:0px; margin:0px; display:none"), r.setAttribute("sandbox", "allow-scripts allow-same-origin"), r.setAttribute("aria-hidden", "true"), r.title = "Criteo GUM iframe", N.removeLater(n, r), r
    ...
    function b() {
        this.abe = void 0, this.isCbsEnabled = !1, this.uat = void 0, this.shouldFillPageId = v("shouldFillPageId", !0)
    }
    ...
    function ne(e, t, n, o, i) {
        ...
        return document && window.location.hash && (a = U.exec(window.location.hash)) && 4 === a.length && (r = "enable" === a[1], a = Number(a[3]), new u("criteoTagDebugMode", r ? 864e5 : 0).setValueWithNoDomain(r && a && !isNaN(a) ? String(a) : "0"), window.location.href = window.location.href.substr(0, window.location.href.indexOf("#"))), document && "function" == typeof Array.prototype.indexOf && -1 !== document.cookie.indexOf("criteoTagDebugMode=") ? (c = i, s = {
            ...
            push: function() {
                for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                0 < e.length && this.stagedPushes.push(e), c.stopRecordingInit()
            },
        ...
        }(window.onerror), r = s, document && (a = "ld-tag-debug." + T + ".js", (i = document.createElement("script")).setAttribute("type", "text/javascript"), i.setAttribute("src", document.location.protocol + "//static.criteo.net/js/ld/" + a), (a = document.getElementsByTagName("script")[0]).parentNode.insertBefore(i, a)), r) : e
    }
    ...
    function se() {
        ...
        var e, n, t, o, i, r, a, c, s, F = new D,
            ...
            w = u ? new Q(F, l, window, C) : new Y,
            b = new(u ? $ : X),
            d = new H(window),
            E = new ie(document, F),
            x = (r = d.retrieveConsent.bind(d), a = !1, c = void 0, s = [], function(e) {
                a ? e(c) : (s.push(e), 1 === s.length && r(function(e) {
                    a = !0, c = e;
                    for (var t = 0, n = s; t < n.length; t++)(0, n[t])(c)
                }))
            });

        function S(e, t, n, o, i, r, a, c, s, u, l) {
            e.waitingForSyncframe && (e.waitingForSyncframe = !1, m(e, t, n, o, i, r, a, c, s, u, l))
        }
        ...
        function f(h, f, g, m, v, y, C, w, b, k, P, e) {
            h.shouldInjectSyncframe() && (e = h.createIframe(m, w.tagVersion, F, w.privateModeDetectionEnabled, e), window.addEventListener) && (F.addProtectedEventListener(window, "message", function(e) {
                var t, n, o, i, r, a, c, s, u, l, d, p;
                t = h, n = f, o = g, i = m, r = v, a = y, c = C, s = w, u = b, l = k, d = P, ((p = (e = e).data) && e.origin == t.gumSyncFrameOrigin || window.BypassSyncframeMessageSanityCheck) && (e.stopPropagation(), i.checkCookies(p), t.waitingForSyncframe) && S(t, n, o, i, r, a, c, s, u, l, d)
            }, !0), O(f, k, b, {
                event: "appendtag",
                element: e
            }))
        ...
        function p(e, t) {
            ...
            if (200 < n.length) o = !0;
                ...
                for (var i = 0, r = n; i < r.length; i++) {
                    var a = r[i],
                        c = 0;
                    if (Object.keys) c = Object.keys(a).length;
                    else
                        for (var s in a) Object.prototype.hasOwnProperty.call(a, s) && (c += 1);
                    if (200 < c) {
                        o = !0;
                        break
                    }
        ...
        function m(e, t, n, o, i, r, a, c, s, u, l) {
            for (var d = [], p = t.queue, h = 0; h < p.length; ++h) {
                ...
                else if (f && "[object Object]" === f.toString()) switch (function(e, t, n, o, i, r, a, c, s, u, l, d, p, h) {
                    var f = l.event,
                        g = L(e, l);
                    if (null !== g) return g;
                    switch (l.event) {
                        ...
                        case "flush":
                        case "flushevents":
                            return P(e, t, n, o, i, r, a, c, s, u, d !== p.length - 1 || 0 !== h.length), 1;
                        case "setaccount":
            ...
            s.afterEval instanceof Function && s.afterEval(), t.queue = d || [], u.manualFlush || u.noPartialFlush && 0 !== t.queue.length || e.waitingForSyncframe || P(t, n, o, i, r, a, c, s, u, l, 0 !== t.queue.length)
        }
        ...
        function P(n, o, e, t, i, r, a, c, s, u, l) {
            if (c.onFlush instanceof Function && (c.onFlush(), W.warn("on flush hook is deprecated and will soon be removed. Please do not use it and contact criteo if you think this may break your integration")), 0 !== n.actions.length) {
                ...
                var _ = !1,
                    ...
                    R = (n.actions = [], function() {
                        ...
                        }, "function" == typeof c.onUrlGenerated ? c.onUrlGenerated(t.url) : "beacon" === a.requestType && navigator.sendBeacon ? navigator.sendBeacon(t.url) : O(n, s, c, t), W.info("DIS call triggered", t.url, D), (n.eventSent = !0) === t.isImgUrl && E.registerTrigger(e), s.disOnce) || (n.disingScheduled = [])
                    }),
                    A = function() {
        ...
        function U(e, t, n, o, i) {
            var r, a, c, s, u, l = encodeURIComponent || escape,
                d = "";
            if (o instanceof Function) d = U(e, t, n, o(), i);
                ...
                var f, g, m = [];
                for (f in o) o.hasOwnProperty(f) && (g = i.concat([f]), m.push((c = e, s = f, u = (u = g).join("."), (c.properties[u] || s) + "=" + U(e, t, n, o[f], g))));
                d += m.join("&")
        ...
        return F.catchAndStoreException(function() {
            w.checkAcid(), w.checkClientSideIdentityStatus(), w.setCop(window), e = b, t = y.app, n = y.cbs, o = w, i = C.shortNameMap, r = C.encodingConfig, a = C.parsingConfig, c = C.trackingCallData, s = C.hooks, u = C.workflow, l = C.identifierScrappingConfig, e.setWaitingFlag(o), e.waitingForSyncframe && F.setProtectedTimeout(function() {
                S(e, t, n, o, i, r, a, c, s, u, l)
            ...
            var e, t, n, o, i, r, a, c, s, u, l, d = C.trackingCallData.extraData;
            try {
                var p = N.getAnchorWithReferrer(document);
                p && p.hostname !== document.location.hostname && K(d, {
                    event: "setData",
    ...
    }(!window.criteo_q || window.criteo_q instanceof Array) && (P = window.criteo_q || [], window.criteo_q = se(), P.adBlockDetector, window.criteo_q.adBlockDetector = P.adBlockDetector, (re = window.criteo_q).push.apply(re, P))
}();